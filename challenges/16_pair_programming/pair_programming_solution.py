...
# try to withdraw more than the balance account
...
# One nice way to do this is to write a validate() function, and run this first within the withdraw()/deposit() functions
...
deposit_secure(my_account, 10)
print(my_account)
withdraw_secure(my_account, 2)
print(my_account)
