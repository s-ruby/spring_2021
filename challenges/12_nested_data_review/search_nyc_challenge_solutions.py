...
# TODO: 1.3 Print the names of the borough's airports
for airport in borough['airports']:
    print(airport['name'])

# TODO: 1.4 Write an if/else statement to see if a 'parks' key exists in the borough dictionary...
...
for borough in nyc:
    ...
    if places_input in borough:
        for place in borough[places_input]:
            print('\t' + place['name'])
