...
ash_account = CheckingAccount('Ash Rahman', 1100222)
# 2.2 Deposit the amount of 1500
ash_account.deposit(1500)
# 2.3 Withdraw the amount of 4000
ash_account.withdraw(4000)
# 2.4 Print the account balance
print(ash_account.balance)
